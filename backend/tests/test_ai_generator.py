...
class TestAIGeneratorToolCalling:
    ...
    def test_generate_response_without_tools(
        self, mock_anthropic_class, mock_claude_response_no_tool
    ):
    ...
    @patch("ai_generator.anthropic.Anthropic")
    def test_generate_response_with_tools_registered(
        self, mock_anthropic_class, mock_claude_response_no_tool
    ):
        ...
        response = generator.generate_response(
            query="What is MCP?", tools=tool_definitions
        )
    ...
    @patch("ai_generator.anthropic.Anthropic")
    def test_stops_on_first_non_tool_response(
        self, mock_anthropic_class, mock_tool_manager
    ):
    ...
    def test_tool_error_in_second_round(self, mock_anthropic_class, mock_tool_manager):
        ...
        tool_result_message = third_call_messages[
            -1
    ...
    @patch("ai_generator.anthropic.Anthropic")
    def test_message_context_preservation_across_rounds(
        self, mock_anthropic_class, mock_tool_manager
    ):
...
class TestAIGeneratorEdgeCases:
    ...
    def test_tool_use_without_tool_manager(
        self, mock_anthropic_class, mock_claude_response_with_tool
    ):
