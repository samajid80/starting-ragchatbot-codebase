...
class TestRAGSystemQuery:
    ...
    def test_query_happy_path_with_tools(
        ...
        with patch('rag_system.DocumentProcessor'), \
            ...
            mock_ai.generate_response.return_value = "MCP is a protocol for AI context management."
...
class TestRAGSystemInitialization:
    ...
    def test_initialization_creates_all_components(self, mock_config):
        ...
        with patch('rag_system.DocumentProcessor') as mock_dp, \
            ...
            # Assert
            mock_dp.assert_called_once_with(mock_config.CHUNK_SIZE, mock_config.CHUNK_OVERLAP)
            mock_vs.assert_called_once_with(mock_config.CHROMA_PATH, mock_config.EMBEDDING_MODEL, mock_config.MAX_RESULTS)
    ...
    def test_initialization_registers_tools(self, mock_config):
        ...
        with patch('rag_system.DocumentProcessor'), \
            ...
            tool_names = [tool_def["name"] for tool_def in rag.tool_manager.get_tool_definitions()]
...
class TestRAGSystemIntegration:
    ...
    def test_content_query_full_flow(
        self,
        mock_config,
        sample_search_results
    ):
        ...
        with patch('rag_system.DocumentProcessor'), \
            ...
            def generate_with_tool_call(query, conversation_history=None, tools=None, tool_manager=None):
                if tool_manager:
